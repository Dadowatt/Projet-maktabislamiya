            ...
            <div class="col-12 col-sm-6 col-md-3 mb-4" style="max-width: 250px;">
                <div class="card shadow-sm" style="height: 27rem;">
                    <img src="{{ $livre->image_couverture ? asset('storage/'.$livre->image_couverture) : asset('default-cover.jpg') }}"
                         class="card-img-top shadow" alt="Couverture" style="height: 18rem; object-fit: cover;">
                    <div class="card-body d-flex flex-column justify-content-between">
                        ...
                        @if($livre->pdf_url)
                            <a href="{{ asset('storage/' . $livre->pdf_url) }}" target="_blank" class="btn btn-outline-secondary btn-sm mb-2">
                                Télécharger le PDF
                            </a>
                        @endif
