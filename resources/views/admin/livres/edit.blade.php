...
<div class="container mt-4">
    ...
    <form action="{{ route('admin.livres.update', $livre) }}" method="POST" enctype="multipart/form-data" class="w-75 mx-auto bg-light p-4 rounded">
        @csrf
        @method('PUT')
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control" id="description" name="description" rows="3">{{ old('description', $livre->description) }}</textarea>
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
            <label for="pdf_url" class="form-label">Lien du PDF (Drive, etc.)</label>
            <input type="url" class="form-control" id="pdf_url" name="pdf_url" value="{{ old('pdf_url', $livre->pdf_url) }}" required>
        </div>
        <div class="mb-3">
