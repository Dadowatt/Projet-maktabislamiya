    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-3 text-center text-md-start">
                <div
                    style="border:3px solid #3498db; border-radius:50%; width:150px; height:150px; overflow:hidden; margin: 0 auto 10px auto;">
                    ...
                    <div class="card shadow-sm" style="height: 27rem;">
                        ...
                        <div class="card-body d-flex flex-column justify-content-between">
                            ...
                            <div class="d-flex align-items-center justify-content-between mt-auto">
                                <a href="{{ route('admin.livres.show', $livre) }}" class="btn btn-success btn-sm fw-bold">Voir
                                    plus</a>
                            </div>
                        </div>
                    </div>
