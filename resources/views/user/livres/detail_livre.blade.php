        ...
        <div class="row g-0">
            ...
            <div class="col-sm-12 col-md-8">
                <div class="card-body">
                    ...
                    <p class="catd-text"><strong>Auteur :</strong> <a
                            href="{{ route('user.auteurs.show', $livre->auteur->id ?? '') }}">
                    ...
                    <div>
                        <span>
                            @for($i = 1; $i <= 5; $i++)
                                <i
                                    class="fa-solid fa-star{{ $i <= round($noteMoyenne) ? ' text-warning' : ' text-secondary' }}"></i>
                            @endfor
                        </span>
                    ...
                    <div class="d-flex align-items-center">
                        <a href="{{ route('user.livres.lecture', $livre->id) }}" class="btn btn-success me-3"
                            target="_blank">
                            Lecture
                        </a>
                        <a href="{{ asset('storage/' . $livre->pdf_url) }}" class="btn btn-sm btn-outline-success p-2 me-3"
                            download>
                            Télécharger le PDF
                        </a>
