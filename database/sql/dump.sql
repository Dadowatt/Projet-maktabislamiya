...
--
-- Index pour la table `auteur_suivis`
--
ALTER TABLE `auteur_suivis`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `auteur_suivis_user_id_auteur_id_unique` (`user_id`,`auteur_id`),
  ADD KEY `auteur_suivis_auteur_id_foreign` (`auteur_id`);

--
-- Index pour la table `book_requests`
--
...
ALTER TABLE `categorie_user`
  ADD PRIMARY KEY (`id`),
  ADD KEY `categorie_user_categorie_id_foreign` (`categorie_id`),
  ADD KEY `categorie_user_user_id_foreign` (`user_id`);
...
--
-- Index pour la table `demande_livres`
--
ALTER TABLE `demande_livres`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `favoris`
  ADD PRIMARY KEY (`id`),
  ADD KEY `favoris_livre_id_foreign` (`livre_id`),
...
ALTER TABLE `lectures`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `livre_user_unique` (`livre_id`,`user_id`),
...
--
-- Index pour la table `livre_user`
--
ALTER TABLE `livre_user`
  ADD PRIMARY KEY (`id`),
  ADD KEY `livre_user_user_id_foreign` (`user_id`),
  ADD KEY `livre_user_livre_id_foreign` (`livre_id`);
...
ALTER TABLE `notes`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `notes_livre_id_user_id_unique` (`livre_id`,`user_id`),
...
--
-- AUTO_INCREMENT pour la table `auteur_suivis`
--
ALTER TABLE `auteur_suivis`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;

--
-- AUTO_INCREMENT pour la table `book_requests`
--
ALTER TABLE `book_requests`
...
--
-- AUTO_INCREMENT pour la table `demande_livres`
--
ALTER TABLE `demande_livres`
...
--
-- AUTO_INCREMENT pour la table `livre_user`
--
ALTER TABLE `livre_user`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
-- Contraintes pour la table `auteur_suivis`
--
ALTER TABLE `auteur_suivis`
  ADD CONSTRAINT `auteur_suivis_auteur_id_foreign` FOREIGN KEY (`auteur_id`) REFERENCES `auteurs` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `auteur_suivis_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;

--
-- Contraintes pour la table `categorie_user`
--
ALTER TABLE `categorie_user`
  ADD CONSTRAINT `categorie_user_categorie_id_foreign` FOREIGN KEY (`categorie_id`) REFERENCES `categories` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `categorie_user_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
...
--
ALTER TABLE `favoris`
  ADD CONSTRAINT `favoris_livre_id_foreign` FOREIGN KEY (`livre_id`) REFERENCES `livres` (`id`) ON DELETE CASCADE,
...
--
ALTER TABLE `lectures`
  ADD CONSTRAINT `lectures_livre_id_foreign` FOREIGN KEY (`livre_id`) REFERENCES `livres` (`id`) ON DELETE CASCADE,
...
--
ALTER TABLE `livres`
  ADD CONSTRAINT `livres_auteur_id_foreign` FOREIGN KEY (`auteur_id`) REFERENCES `auteurs` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `livres_categorie_id_foreign` FOREIGN KEY (`categorie_id`) REFERENCES `categories` (`id`) ON DELETE SET NULL;

--
-- Contraintes pour la table `livre_user`
--
ALTER TABLE `livre_user`
  ADD CONSTRAINT `livre_user_livre_id_foreign` FOREIGN KEY (`livre_id`) REFERENCES `livres` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `livre_user_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;

--
-- Contraintes pour la table `notes`
--
ALTER TABLE `notes`
  ADD CONSTRAINT `notes_livre_id_foreign` FOREIGN KEY (`livre_id`) REFERENCES `livres` (`id`) ON DELETE CASCADE,
